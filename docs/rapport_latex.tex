...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{../reports/figures/acm_modalities_12.png}
...
\textbf{Observation} (Fig.~\ref{fig:individuals}) : Séparation partielle edible/poisonous sur l'axe 1, nuages se chevauchent. Les 5 axes (31,3\% inertie) amélioreront la discrimination (sections 4-5).
...
\bibitem{uci}
Dua, D. and Graff, C. (2019). \textit{UCI Machine Learning Repository}. \url{http://archive.ics.uci.edu/ml}

\bibitem{audubon}
Lincoff, G. H. (1981). \textit{The Audubon Society Field Guide to North American Mushrooms}. Alfred A. Knopf.

\bibitem{lebart}
Lebart, L., Morineau, A., et Piron, M. (2006). \textit{Statistique exploratoire multidimensionnelle}. Dunod.
