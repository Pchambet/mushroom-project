...
% babel removed to avoid package errors
\usepackage{geometry}
\usepackage{graphicx}
\usepackage{float}
\usepackage{amsmath}
...
\texttt{stalk-surface-} \texttt{above-ring} & Surface pied au-dessus anneau : \texttt{f} = fibrous, \texttt{y} = scaly, \texttt{k} = silky, \texttt{s} = smooth \\
\texttt{stalk-surface-} \texttt{below-ring} & Surface pied en-dessous anneau : \texttt{f} = fibrous, \texttt{y} = scaly, \texttt{k} = silky, \texttt{s} = smooth \\
\texttt{stalk-color-} \texttt{above-ring} & Couleur pied au-dessus anneau : \texttt{n} = brown, \texttt{b} = buff, \texttt{c} = cinnamon, \texttt{g} = gray, \texttt{o} = orange, \texttt{p} = pink, \texttt{e} = red, \texttt{w} = white, \texttt{y} = yellow \\
\texttt{stalk-color-} \texttt{below-ring} & Couleur pied en-dessous anneau : \texttt{n} = brown, \texttt{b} = buff, \texttt{c} = cinnamon, \texttt{g} = gray, \texttt{o} = orange, \texttt{p} = pink, \texttt{e} = red, \texttt{w} = white, \texttt{y} = yellow \\
